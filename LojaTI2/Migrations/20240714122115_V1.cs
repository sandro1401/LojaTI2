    ...
    public partial class V1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotaFiscalModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotaFiscalModel_Cliente_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotaFiscalModelId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemPedido", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemPedido_NotaFiscalModel_NotaFiscalModelId",
                        column: x => x.NotaFiscalModelId,
                        principalTable: "NotaFiscalModel",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Endereco_ClienteModelId",
                table: "Endereco",
                column: "ClienteModelId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemPedido_NotaFiscalModelId",
                table: "ItemPedido",
                column: "NotaFiscalModelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotaFiscalModel_ClienteId",
                table: "NotaFiscalModel",
                column: "ClienteId");
